...
namespace ftp_add
{
    public partial class Form1 : Form
    {
        private void subirArchivos(string direccionFTP, string rutaArchivo, string usuario, string contrasena)
        {
            ...
            FtpWebRequest request = (FtpWebRequest)FtpWebRequest.Create("ftp://files.000webhost.com/public_html/" + "/" + Path.GetFileName("C:\\Users\\yunio\\Desktop\\a20147190.txt "));
            ...
            //Cargando el archivo.
            FileStream stream = File.OpenRead("C:\\Users\\yunio\\Desktop\\a20147190.txt ");
